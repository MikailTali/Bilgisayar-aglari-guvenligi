def Mikail(subnet_mask): # Fonksiyon oluşturduk
...
for subnet, Mikail_tali in subnet_masks.items(): # subnet_masks sözlüğünün key-value değerlerini döndürüp subnet değerlerini Mikail_tali olarak aldık. onu da subnet'e attık
    hosts = Mikail(Mikail_tali) #  Mikail fonksiyonundan Mikail_tali değerlerini aldık onu da hosts sayısına attık.
